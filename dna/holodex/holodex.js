...
var dna = function (exports) {
 ...
 ================================= */
	...
	var processString$1 = function processString$1(str) {
 ...
 ======================================== */
	...
	function index(_ref) {
		...
		indexSpec[entryType].indexFields.forEach(function (_ref2) {
			var fieldName = _ref2.fieldName,
			    weight = _ref2.weight;

			debug('Extracted Keywords:' + JSON.stringify(processString$1(entryFlat[fieldName])));
	...
	function search(_ref3) {
		...
		processString(queryString).forEach(function (keyword) {
			indexSpec[entryType].indexFields.forEach(function (_ref4) {
				var fieldName = _ref4.fieldName,
				    weight = _ref4.weight;

				var keywordAnchorHash = makeHash('keywordAnchor', { entryType: entryType, fieldName: fieldName, keyword: keyword });
				if (hashExists(keywordAnchorHash)) {
					getLinks(keywordAnchorHash, '').forEach(function (_ref5) {
						var Hash = _ref5.Hash;
	...
	exports.bridgeGenesis = bridgeGenesis;
	exports.index = index;
