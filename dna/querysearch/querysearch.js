...
function indexKeyword(_ref) {
  ...
  textSearchSpec()[entryType].indexFields.forEach(function (_ref2) {
...
function index(_ref3) {
  ...
  var skeletalEntry = indexSpec()[entryType].reduce(function (obj, field) {
...
function queryHD(_ref4) {
  var entryType = _ref4.entryType,
      queryOptions = _ref4.queryOptions;
...
function search(_ref5) {
  ...
  processString(queryString).forEach(function (keyword) {
    textSearchSpec()[entryType].indexFields.forEach(function (_ref6) {
